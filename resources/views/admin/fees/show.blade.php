...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.fees.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <fees-view
                        fetch-url="{{ route('admin.fees.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.fees.update', $item->id) }}"
                        ></fees-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.fees', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
