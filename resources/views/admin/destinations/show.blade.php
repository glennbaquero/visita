            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <destinations-view
                        fetch-url="{{ route('admin.destinations.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.destinations.update', $item->id) }}"
                    ...
                    <div class="tab-pane" id="tab2">
                        <capacities-table 
                        ref="table-2"
                        fetch-url="{{ route('admin.capacities.fetch', ['destination_show' => $item->id]) }}"
                        ></capacities-table>
                    </div>
