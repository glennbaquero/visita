...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.blocked-dates.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <blocked-dates-view
                        fetch-url="{{ route('admin.blocked-dates.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.blocked-dates.update', $item->id) }}"
                        ></blocked-dates-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.blocked-dates', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
