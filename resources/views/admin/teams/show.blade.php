...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.teams.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <teams-view
                        fetch-url="{{ route('admin.teams.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.teams.update', $item->id) }}"
                        ></teams-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.teams', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
