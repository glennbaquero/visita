...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.frame-three.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <frame-three-view
                        fetch-url="{{ route('admin.frame-three.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.frame-three.update', $item->id) }}"
                        ></frame-three-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.frame-three', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
