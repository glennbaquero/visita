...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('admin.add-ons.index') }}">Add Ons</a></li>
    ...
    <page-pagination fetch-url="{{ route('admin.add-ons.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <add-ons-view
                        fetch-url="{{ route('admin.add-ons.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.add-ons.update', $item->id) }}"
                    ...
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.add-ons', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
