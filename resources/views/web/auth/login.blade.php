            ...
            <div class="vertical-parent">
                <div class="vertical-align align-b">
                    <div class="margin-a width--85">
                        <p class="lgn-frm1__col-header frm-header s-margin-b clr--white">{{ $data['pageItems']['frame_1_title'] }}</p>
                        <h5 class="lgn-frm1__col-label frm-title clr--white">{{ $data['pageItems']['frame_1_label'] }}</h5>
                    </div>
                </div>
            </div>
            <div class="frm-bckgrnd size-cover bring-back" style="background-image: url('{!! $data['pageItems']['frame_1_background_image'] !!}');"></div>
        </div
                ...
                <div class="vertical-align">
                    <div class="margin-a width--80">
                        ...
                        <div class="inlineBlock-parent align-c">
                            ...
                            <a href="{{ route('web.google.login') }}" class="frm-btn lgn-frm1__login-scl-btn google m-margin-b"><img src="{{ asset('images/google-plus-icon.png') }}">Google</a>
                        </div>
                        <div class="lgn-frm1__sign-up-holder width--100 inlineBlock-parent align-c">
